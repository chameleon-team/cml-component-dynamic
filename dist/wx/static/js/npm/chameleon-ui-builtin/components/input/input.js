...
var __INTERFACE__FILEPATH = "/Users/didi/work/cml-test/cml-component-dynamic/node_modules/chameleon-ui-builtin/components/input/input.interface";
...
function pxTransform(s) {
    ...
    if (!!~s.indexOf('cpx')) {
        return s.replace(/(-?\d*\.?\d*)cpx/ig, function (matchs, $1) {
            return _chameleonApi2.default.cpx2px(Number($1)) + 'px';
        });
    }
    return s;
}
